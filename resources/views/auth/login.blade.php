...
<head>
    ...
    <title>Eastern Tech - Login</title>
    <!-- BEGIN: CSS Assets-->
    ...
    <div class="block xl:grid grid-cols-2 gap-4">
        ...
        <div class="hidden xl:flex flex-col min-h-screen">
            <a href="" class="-intro-x flex items-center pt-5">
                ...
                <span class="text-white text-lg ml-3"> Eastern<span class="font-medium">Tech</span> </span>
            </a>
            <div class="my-auto">
            ...
            <div class="my-auto mx-auto xl:ml-20 bg-white dark:bg-dark-1 xl:bg-transparent px-5 sm:px-8 py-8 xl:p-0 rounded-md shadow-md xl:shadow-none w-full sm:w-3/4 lg:w-2/4 xl:w-auto">
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="intro-x mt-8">
                        <input type="text" name="email" class="@error('email') is-invalid @enderror intro-x login__input form-control py-3 px-4 border-gray-300 block" placeholder="Email">
                        @error('email')
                        ...
                        <input type="password" name="password" class="@error('password') is-invalid @enderror intro-x login__input form-control py-3 px-4 border-gray-300 block mt-4" placeholder="Password">
                        @error('password')
                        <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
