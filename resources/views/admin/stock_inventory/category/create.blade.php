...
@section('content')
    <div class="col-md-12">
        ...
        <div class="kt-portlet">
            ...
            <!--begin::Form-->
            <form class="kt-form" method="post" id="create_StockCategory">
                @csrf
                <div class="kt-portlet__body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="stock_category_name" class="form-control" aria-describedby="emailHelp" placeholder="Enter stock category">
                    </div>
...
<script>
    $(document).ready(function () {
        $("#create_StockCategory").on("submit",function (e) {
            e.preventDefault();
            var formData = $("#create_StockCategory").serializeArray();
            $.ajax({
                url : "{{ route('stock_category.store') }}",
                type: "post",
                data: $.param(formData),
                dataType: "json",
