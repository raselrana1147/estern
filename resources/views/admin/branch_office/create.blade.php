...
@section('content')
    <div class="col-md-12">
        ...
        <div class="kt-portlet">
            ...
            <!--begin::Form-->
            <form class="kt-form" method="post" id="create_branch_office">
                @csrf
                <div class="kt-portlet__body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="fblink" class="form-control" aria-describedby="emailHelp" placeholder="Enter phone">
                    </div>

                    <div class="form-group">
                        <label>Address</label>
                        <textarea class="form-control" name="address" rows="4" cols="40" placeholder="Address"></textarea>
                    </div>
...
<script>
    $(document).ready(function () {
        $("#create_branch_office").on("submit",function (e) {
            e.preventDefault();
            var formData = $("#create_branch_office").serializeArray();
            $.ajax({
                url : "{{ route('branch_office.store') }}",
                type: "post",
                data: $.param(formData),
                dataType: "json",
