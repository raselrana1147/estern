...
@section('content')
    <div class="col-md-12">
        ...
        <div class="kt-portlet">
            ...
            <!--begin::Form-->
            <form class="kt-form" method="post" id="update_customer_role">
                @csrf
                <div class="kt-portlet__body">
                    ...
                    <div class="form-group">
                        ...
                        <select name="user_role_id" id="user_role_id" class="form-control">
                            ...
                            <option value="2" @if($customer->user_role_id == 2) selected @endif>Executive</option>
                            <option value="3" @if($customer->user_role_id == 3) selected @endif>Customer</option>
                            <option value="4" @if($customer->user_role_id == 4) selected @endif>Member</option>
                            <option value="5" @if($customer->user_role_id == 5) selected @endif>Rider</option>
                        </select>
                    </div>
...
<script>
    $(document).ready(function () {
        $("#update_customer_role").on("submit",function (e) {
            e.preventDefault();

            var id = $("#customer_id").val();

            var formData = $("#update_customer_role").serializeArray();
