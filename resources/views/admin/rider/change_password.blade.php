...
@section('content')
    <div class="col-md-12">
        ...
        <div class="kt-portlet" id="edit_form_body">
            ...
            <!--begin::Form-->
            <form class="kt-form" method="post" id="change_rider_password">
                @csrf
                <div class="kt-portlet__body">
                    ...
                    <h5><strong>Rider Change Password</strong></h5><hr>
...
<script>
    ...
    $(document).ready(function () {
        $("#change_rider_password").on("submit",function (e) {
            e.preventDefault();

            var id = $("#rider_id").val();

            var formData = new FormData( $("#change_rider_password").get(0));

            $.ajax({
                url : "{{ route('rider.updatePassword','') }}/"+id,
                type: "post",
                data: formData,
                dataType: "json",
                contentType: false,
