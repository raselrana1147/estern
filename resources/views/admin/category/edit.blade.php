...
@section('content')
    <div class="col-md-12">
        ...
        <div class="kt-portlet">
            ...
            <!--begin::Form-->
            <form class="kt-form" method="post" id="edit_category">
                @csrf
                <div class="kt-portlet__body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" value="{{ $category->name }}" name="name" class="form-control" aria-describedby="emailHelp" placeholder="Enter category">
                    </div>
...
<script>
    $(document).ready(function () {
        $("#edit_category").on("submit",function (e) {
            ...
            var formData = $("#edit_category").serializeArray();
            $.ajax({
