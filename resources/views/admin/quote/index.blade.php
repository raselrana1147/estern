...
<script>
    $(document).ready(function(){
        $('#kt_table_1').DataTable({
            ...
            columns: [
                ...
                {data: 'name', name: 'name'},
                {data: 'stock_category_name', name: 'stock_category_name'},
                {data: 'stock_brand_name', name: 'stock_brand_name'},
    ...
    $(document).on('click','.quote_status_toggle', function (e) {
        e.preventDefault();
        ...
        $.ajax({
            type: "GET",
            url: "{{ route('quote.status_change','') }}/"+id,
            dataType: 'json',
            success: function (data) {
