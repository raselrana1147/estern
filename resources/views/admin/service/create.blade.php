...
@section('content')
    <div class="col-md-12">
        ...
        <div class="kt-portlet">
            ...
            <!--begin::Form-->
            <form class="kt-form" method="post" id="create_service">
                @csrf
                <div class="kt-portlet__body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="charge" id="charge" class="form-control" placeholder="Enter charge">
                    </div>


                    <div class="form-group">
                        <label>Service Total Duration</label>
                        <input type="text" name="total_duration" id="total_duration" class="form-control" placeholder="Enter total duration">
                    </div>
...
<script>
    ...
    $(document).ready(function () {
        $("#create_service").on("submit",function (e) {
            e.preventDefault();
            var formData = $("#create_service").serializeArray();
            $.ajax({
