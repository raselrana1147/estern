...
@section('content')
    <div class="col-md-12">
        ...
        <div class="kt-portlet">
            ...
            <!--begin::Form-->
            <form class="kt-form" method="post" id="create_subCategory">
                @csrf
                <div class="kt-portlet__body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="name" class="form-control" aria-describedby="emailHelp" placeholder="Enter sub category">
                    </div>
...
<script>
    $(document).ready(function () {
        $("#create_subCategory").on("submit",function (e) {
            e.preventDefault();
            var formData = $("#create_subCategory").serializeArray();
            $.ajax({
