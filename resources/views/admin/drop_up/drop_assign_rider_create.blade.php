...
@section('content')
    <div class="col-md-12">
        ...
        <div class="kt-portlet">
            ...
            <!--begin::Form-->
            <form class="kt-form" method="post" id="create_drop_assign_rider">
                @csrf
...
<script>
    $(document).ready(function () {
        $("#create_drop_assign_rider").on("submit",function (e) {
            e.preventDefault();
            var formData = $("#create_drop_assign_rider").serializeArray();
            $.ajax({
                url : "{{ route('drop_up.drop_assign_rider_store') }}",
                type: "post",
                data: $.param(formData),
                dataType: "json",
