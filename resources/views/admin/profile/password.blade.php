...
@section('content')
    <div class="col-md-12">
        ...
        <div class="kt-portlet" id="edit_form_body">
            ...
            <!--begin::Form-->
            <form class="kt-form" method="post" id="change_user_password">
                @csrf
                <div class="kt-portlet__body">
                    ...
                    <h5><strong>User Change Password</strong></h5><hr>
...
<script>
    ...
    $(document).ready(function () {
        $("#change_user_password").on("submit",function (e) {
            e.preventDefault();

            var id = $("#user_id").val();

            var formData = new FormData( $("#change_user_password").get(0));

            $.ajax({
                url : "{{ route('password.store.user','') }}/"+id,
                type: "post",
                data: formData,
                dataType: "json",
                contentType: false,
