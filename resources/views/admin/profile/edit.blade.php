...
@section('content')
    <div class="col-md-12">
        ...
        <div class="kt-portlet" id="edit_form_body">
            ...
            <!--begin::Form-->
            <form class="kt-form" method="post" id="update_user_info">
                @csrf
                    ...
                    <div class="form-group">
                        ...
                        @if (!empty($user->image))
                            <div>
                                ...
                                <a user_id="{{ $user->id }}" class="text-danger" id="image_delete" style="cursor: pointer;">Remove Image</a>
                            </div>
                        @else
...
<script>
    ...
    $(document).ready(function () {
        $("#update_user_info").on("submit",function (e) {
            ...
            var formData = new FormData( $("#update_user_info").get(0));

            $.ajax({
                url : "{{ route('user.info.update','') }}/"+id,
                type: "post",
                data: formData,
                dataType: "json",
                contentType: false,
