     ...
     <div class="container">
                    ...
                    <div id="primary" class="content-area">
                        <main id="main" class="site-main">
                            ...
                            <section>
                                <header>
                                    <h2 class="h1">{{$single_cat->name}} Categories</h2>
                                </header>
                            ...
                            <div class="tab-pane active" id="tab-products-1" role="tabpanel">
                                <div class="woocommerce columns-12">
                                    ...
                                    <ul class="products columns-4" id="see_by_category" pageNameCat="1" categoryid="{{$single_cat->id}}">
                            ...
                            <div class="load_more_section">
                                     <p class="load_no_more_cat" style="display: none"></p>
